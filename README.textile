...
If you would like a version which doesn't depend on Doctrine, please vote up "this issue":https://github.com/orderly/codeigniter-paypal-ipn/issues/1 so I know to prioritise this.
