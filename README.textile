...
Also note that this library will not work (will return 500 Internal Server Errors) if
CodeIgniter's CSRF protection is left on. In a future version of CodeIgniter you will
however be able to enable CSRF protection but whitelist the IPN action - see this pull
request for more details: https://github.com/EllisLab/CodeIgniter/pull/236
